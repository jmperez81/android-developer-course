...
public class MainActivity extends Activity implements
	...
	public void onCreate(Bundle bundle) {
		...
		editText.setText("/mnt/sdcard/video.mp4");							// Local video
		// editText.setText("http://www.youtube.com/watch?v=14AFpgIctr0");	// Internet video: need to set internet permission in android manifest 		
	...
	private void playVideo() {
		try {
			...
			mediaPlayer.setLooping(true);	// Repeat continuously, onCompletion is never called
			mediaPlayer.prepare();
			//	mediaPlayer.prepareAsync();	// For streaming
	...
	private void log(String s) {
		...
		scrollView.fullScroll(View.FOCUS_DOWN);	// Scroll down everytime something is written
	}
}